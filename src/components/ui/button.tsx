...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "default", size = "md", ...props }, ref) => {
    const variants = {
      ...
      outline: "border border-orange-200 bg-white text-navy shadow-sm hover:border-orange-300 hover:bg-orange-50",
      ghost: "text-navy-soft hover:bg-orange-50 hover:text-orange-700",
